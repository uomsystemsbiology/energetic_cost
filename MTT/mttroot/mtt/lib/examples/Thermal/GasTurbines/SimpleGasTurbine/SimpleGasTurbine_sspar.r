...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % $Id: SimpleGasTurbine_sspar.r,v 1.2 2003/09/14 22:31:45 geraint Exp $
% % $Log: SimpleGasTurbine_sspar.r,v $
% % Revision 1.2  2003/09/14 22:31:45  geraint
% % Replaced ^ with pow (required for -cc and -oct).
% %
